...
public class SpawnList : MonoBehaviour
{
    ...
    {
        {  "red1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "red1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Very berry", description = "" } },
        {  "red2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "red1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Kissable Pink", description = "" } },
        {  "red3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "red1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Cherries Jubilee", description = "" } },
        {  "red4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "red1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Candy Apple", description = "" } },
        {  "red5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "red1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Red Geranium", description = "" } },
        {  "red6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "red1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Raspberry Pink", description = "" } },

        {  "orange1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "orange1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Orange Tiger Lily", description = "" } },
        {  "orange2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "orange1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Fresh Tangerines", description = "" } },
        {  "orange3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "orange1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Pumpkin Patch", description = "" } },
        {  "orange4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "orange1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Jack O Lamtern", description = "" } },
        {  "orange5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "orange1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Carotene", description = "" } },
        {  "orange6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "orange1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Tropical Coral", description = "" } },

        {  "yellow1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "yellow1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Sun Rays", description = "" } },
        {  "yellow2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "yellow1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Warm Gold", description = "" } },
        {  "yellow3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "yellow1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Wheat Stalk", description = "" } },
        {  "yellow4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "yellow1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Sunshower", description = "" } },
        {  "yellow5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "yellow1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Extra Virgin Olive Oil", description = "" } },
        {  "yellow6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "yellow1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Sunbeam", description = "" } },

        {  "green1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "green1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Freshen Up Lime", description = "" } },
        {  "green2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "green2", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Granny Smith Apple", description = "" } },
        {  "green3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "green3", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Spring Green", description = "" } },
        {  "green4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "green4", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Jungle Vine", description = "" } },
        {  "green5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "green5", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Frendale", description = "" } },
        {  "green6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "green6", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Lemon Lime Fizz", description = "" } },

        {  "blue1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "blue1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Bright Teal Surprise", description = "" } },
        {  "blue2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "blue1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Marine Blue", description = "" } },
        {  "blue3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "blue1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Hawaiian Teal", description = "" } },
        {  "blue4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "blue1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Caribbean Sea", description = "" } },
        {  "blue5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "blue1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Clipper Ship Blue", description = "" } },
        {  "blue6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "blue1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Thai Teal", description = "" } },

        {  "violet1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "violet1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Bright Sailing Sky", description = "" } },
        {  "violet2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "violet1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Bright Cornflower Blue", description = "" } },
        {  "violet3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "violet1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Pure Periwinkle", description = "" } },
        {  "violet4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "violet1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Dusty Violet", description = "" } },
        {  "violet5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "violet1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Regal Purple", description = "" } },
        {  "violet6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "violet1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Blue Marina", description = "" } },

        {  "grey1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "grey1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Aged Stucco Grey", description = "" } },
        {  "grey2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "grey1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Distant Haze Green", description = "" } },
        {  "grey3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "grey1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Shaded Brook", description = "" } },
        {  "grey4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "grey1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Ascot Blue", description = "" } },
        {  "grey5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "grey1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Old Monterey Grey", description = "" } },
        {  "grey6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "grey1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Polished Limestone", description = "" } },

        {  "brown1", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "brown1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Council Bluff Tan", description = "" } },
        {  "brown2", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "brown1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Antique Bisque", description = "" } },
        {  "brown3", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "brown1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Dry Goods Neutural", description = "" } },
        {  "brown4", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "brown1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Jefferson House Tan", description = "" } },
        {  "brown5", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "brown1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Grey Birch", description = "" } },
        {  "brown6", new FurnitureProperty { bundle = PAINTS_ASSETS, assetName = "brown1", furnitureType = FurnitureProperty.FurnitureType.WALL_PLACEABLE, title = "Pink Beige", description = "" } }
